    ...
    try {
      ...
      if (res.data.event_id) {
        await API.post("/reminders", {
          ...
          remind_before_minutes: parseInt(form.remind_before_minutes),
          reminder_type: form.reminder_type,
        });
      }

      showToast("Event created! Participants notified by email.");
      navigate("/events");
    } catch (err) {
    ...
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "32px 24px" }}>
      <div style={{ marginBottom: "20px" }}>
        ...
        <div style={{ color: "var(--slate)", fontSize: "14px" }}>
          Fill in the details below — shared events notify all participants
          automatically
        </div>
      </div>
      ...
      >
        ...
        <form onSubmit={handleSubmit} style={{ padding: "28px" }}>
          ...
          <div style={{ marginBottom: "24px" }}>
            <div style={sectionLabelStyle}>Visibility & Sharing</div>
            <div
              style={{
                display: "grid",
                gridTemplateColumns: "1fr 1fr",
            ...
            <div>
              <label style={labelStyle}>
                Invite Participants (User IDs, comma separated)
              </label>
              <input
                name="participants"
              ...
              >
                Participants will receive an email invitation.
              </div>
            </div>
          </div>
          ...
          {/* Reminder */}
          <div style={{ marginBottom: "24px" }}>
            <div style={sectionLabelStyle}>Reminder</div>
            <div
              style={{
                display: "grid",
                gridTemplateColumns: "1fr 1fr",
